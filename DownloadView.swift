                ...
                ScrollView {
                    VStack(spacing: 20) {
                        ...
                        VStack(alignment: .leading, spacing: 20) {
                            Text("⚡️ Download source").font(.headline).fontWeight(.bold)
                            HStack {
                            ...
                            HStack {
                                ...
                                Button(action: {}) {
                                    Text("Paste").fontWeight(.bold).padding(.horizontal, 15).padding(.vertical, 8).background(Color.yellow).foregroundColor(.black).cornerRadius(15)
                                }
