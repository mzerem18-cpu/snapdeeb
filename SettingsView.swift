                ...
                ScrollView {
                    VStack(spacing: 15) {
                        ...
                        SectionCard(icon: "globe", iconColor: .green, title: "Language", subtitle: "Change app language and layout direction.") {
                            HStack {
                                VStack(alignment: .leading) { Text("English").foregroundColor(.blue).bold(); Text("Current language").font(.caption).foregroundColor(.gray) }
                        ...
                        SectionCard(icon: "circle.lefthalf.filled", iconColor: .yellow, title: "Appearance", subtitle: "Choose the mode that fits your device.") {
                            HStack {
                                Text("System").bold().frame(maxWidth: .infinity).padding(.vertical, 10).background(Color.yellow).cornerRadius(10)
                        ...
                        SectionCard(icon: "lock.shield.fill", iconColor: .green, title: "Privacy", subtitle: "Clear screen for storage and permission details.") {
                            HStack { Text("Open Privacy Center").bold(); Spacer(); Image(systemName: "chevron.right").foregroundColor(.gray) }.padding().background(Color(UIColor.systemGray6)).cornerRadius(15)
                        }
                        ...
                        SectionCard(icon: "info.circle.fill", iconColor: .cyan, title: "App Information", subtitle: "Developer info, channels, and contact links.") {
                            HStack {
                                ...
                                VStack(alignment: .leading) {
                                    ...
                                    Text("✨ INC DEV").font(.subheadline).bold().foregroundColor(.white).padding(.horizontal, 10).padding(.vertical, 5).background(LinearGradient(gradient: Gradient(colors: [.blue, .purple]), startPoint: .leading, endPoint: .trailing)).cornerRadius(10)
                                }
                                Spacer()
